...
#line hidden
            {
#line 11 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 13 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 16 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\Quantum Projects\\QuantumRNG\\Program.qs", OperationFunctor.Body, 19, 35)]
    public partial class SampleRandomNumberInRange : Operation<(Int64,Int64), Int64>, ICallable
    {
        ...
        {
            var (min,max) = __in__;
#line 20 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 21 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            if ((min >= max))
            {
#line 22 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                return -(1L);
            }

#line 24 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 25 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 26 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 27 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 29 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
...
#line 31 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("D:\\Quantum Projects\\QuantumRNG\\Program.qs", OperationFunctor.Body, 35, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 36 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            var min = 50L;
#line 37 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            var max = 40L;
#line 39 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            var output = SampleRandomNumberInRange__.Apply((min, max));
#line 40 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            if ((output == -(1L)))
            {
#line 41 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                Message__.Apply("Min cannot be greater or equal than max.");
            }
            else
            {
#line 43 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
                Message__.Apply(String.Format("Sampling a random number between {0} and {1}: ", min, max));
            }

#line 45 "D:\\Quantum Projects\\QuantumRNG\\Program.qs"
            return output;
        }
